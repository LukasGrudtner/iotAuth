...
*/
long int KeyManager::getClientPublicKeyD()
{
    return rsaKeys.publicRSAKey.d;
}

long int KeyManager::getClientPublicKeyN()
{
    return rsaKeys.publicRSAKey.n;
}

/*  getServerPrivateKey()
    Retorna a chave privada do servidor armazenada no objeto.
*/
long int KeyManager::getClientPrivateKeyE()
{
    return rsaKeys.privateRSAKey.e;
}

long int KeyManager::getClientPrivateKeyN()
{
    return rsaKeys.privateRSAKey.n;
}

/*  getClientPublicKey()
    Retorna a chave pública do cliente armazenada no objeto.
*/
long int KeyManager::getServerPublicKeyD()
{
    return serverPublicKey.d;
}

long int KeyManager::getServerPublicKeyN()
{
    return serverPublicKey.n;
}

/*  setClientPublicKey()
    Armazena a chave pública do cliente no objeto.
*/
void KeyManager::setServerPublicKey(PublicRSAKey publicKey)
{
